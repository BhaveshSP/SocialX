package com.bhaveshsp.socialx.signinsignup
...
import com.bhaveshsp.socialx.utils.EmailValidator
...
class SignUpFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter : ArrayAdapter<String> = ArrayAdapter(activity!!,R.layout.snipper_layout_item,countryCodesList)
...
//        countryCodeSpinner.
    ...
    private fun changeTab(){
        val tabs : TabLayout = activity!!.findViewById(R.id.tabLayout)
